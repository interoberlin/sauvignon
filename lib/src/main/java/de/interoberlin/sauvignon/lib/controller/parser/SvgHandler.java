package de.interoberlin.sauvignon.lib.controller.parser;
...
public class SvgHandler {
    ...
    public static SVG getSVGFromFile(String svgPath) throws IOException, XmlPullParserException {
        InputStream inputStream = new FileInputStream(new File(svgPath));
        SVG svg = getSVGFromInputStream(inputStream);
        inputStream.close();
        return svg;
    }
